...
// function Nav({ messageCount, clock }) {
//   return (
...
//         {messageCount ? "Active session" : "New session"}
//       </p>
//       {messageCount > 0 && (
//         <>
...
// function Nav({ messageCount}) {
//   const { selectedConversation } = useSelector((state) => state.conversation);

//   return (
//     <div className="relative h-14 border-b border-black/[0.07] flex items-center gap-4 px-6 bg-white/35 backdrop-blur-xl z-10 overflow-hidden motion-safe:animate-[fadeUp_0.5s_ease-out_both]">
//       <p className="text-sm font-medium">
//         {selectedConversation?.title || (messageCount ? "Active session" : "New session")}
//       </p>
//       {messageCount > 0 && (
//         <>
//           <span className="w-1 h-1 rounded-full bg-black/20" />
